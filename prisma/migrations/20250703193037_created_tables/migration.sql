...
CREATE TABLE "delicery_logs" (
    ...
    CONSTRAINT "delicery_logs_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "delicery_logs" ADD CONSTRAINT "delicery_logs_delivery_id_fkey" FOREIGN KEY ("delivery_id") REFERENCES "deliveries"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
